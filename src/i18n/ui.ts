export const ui = {
  es: {
    ...
    orbital: {
      ...
      howItWorksTitle: "Qué hace esta sección",
      howItWorksBody: [
        "Dejás tu idea y la IA te ayuda a definir unos primeros pasos concretos.",
        "Si después pedís construir el MVP, tu mensaje e interés llegan directo a mi mail.",
        "El análisis corre sobre Flowfolio y es superficial: una dirección inicial, no un plan completo.",
      ],
  ...
  en: {
    ...
    orbital: {
      ...
      howItWorksTitle: "What this section does",
      howItWorksBody: [
        "You leave your idea and AI helps define a few concrete first steps.",
        "If you later ask to build the MVP, your message and interest go straight to my inbox.",
        "The analysis runs on Flowfolio and is surface-level: an initial direction, not a full plan.",
      ],
